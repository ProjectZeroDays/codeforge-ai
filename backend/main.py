...
print(f"VENICE_API_KEY loaded: {os.getenv('VENICE_API_KEY') is not None}")
print(f"VENICE_API_SECRET loaded: {os.getenv('VENICE_API_SECRET') is not None}")
...
async def startup_event():
    ...
    print("🔧 Local LLM: Available (not loaded)")
    print("📄 Chat Parser: Ready")
    print("⚙️ Workflow Generator: Ready")
    print("💡 Code Completion: Ready")


@app.on_event("shutdown")
async def shutdown_event():
    """Cleanup on shutdown"""
    print("🛑 Shutting down CodeForge AI...")
